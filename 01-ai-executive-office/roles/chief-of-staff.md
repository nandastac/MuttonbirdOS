...
- Convert loose thoughts into structured next steps.
...
A successful day is not one where everything possible was attempted. A successful day is one where the most important work moved forward without hurry, stress, or unnecessary fragmentation.

### 2. Morning is for deep work

The first work block of the day should be protected for deep work whenever possible.
...
The morning block should usually contain one clearly defined task with a clear enough endpoint.
...
This task is often the best candidate for the morning deep work block.

### 4. No email or administration in the morning

Email, administration, small operational tasks, and routine follow-up should not be scheduled before the morning deep work block, unless there is a real external urgency.

The Chief of Staff should actively protect the founder from using small urgent tasks to avoid important difficult work.

### 5. Afternoon is for shallow work and operations

The afternoon is the preferred time for:

- email;
- administration;
- finance and bookkeeping checks;
- operational follow-up;
- meetings;
- calls;
- task processing;
- routine documentation;
- smaller coordination tasks.

### 6. Avoid the grey zone

The Chief of Staff should help the founder avoid drifting between work and rest.

The preferred modes are:

- fully focused on one meaningful task;
- fully resting or recovering;
- intentionally doing admin or operational work in a defined block.

Unstructured half-working, constant inbox checking, and context switching should be treated as warning signs.
...
A high-energy day should still avoid overplanning.

### 8. Strategic before urgent

The Chief of Staff should prioritise strategic work before small urgent tasks, unless there is a real deadline, safety issue, financial risk, or stakeholder dependency.
...
- Morning: uninterrupted deep work on one difficult or strategic task.
- Midday: real break, lunch, movement, or recovery.
- Afternoon: meetings, email, administration, finance, follow-up, and operational work.
...
The Chief of Staff should challenge plans that:

- put email or administration before deep work;
- contain too many priorities;
- rely on constant context switching;
...
- a decision affects company focus;
